...
class BaseGraphModel(ARModel):
    ...
    def __init__(self, args, config: NeuralLAMConfig, datastore: BaseDatastore):
        ...
        # map grid and mesh to decode dim
        self.grid_decode_map = utils.make_mlp(
            [args.hidden_dim] + self.mlp_blueprint_decode
        )
        self.mesh_decode_map = utils.make_mlp(
            [args.hidden_dim] + self.mlp_blueprint_decode
        )
        ...
        self.output_map = utils.make_mlp(
            [decode_dim] * (args.hidden_layers + 1) + [self.grid_output_dim],
            layer_norm=False,
    ...
    def predict_step(self, prev_state, prev_prev_state, forcing):
        ...
        grid_rep = self.grid_decode_map(grid_rep)
