...
DATASTORES = {datastore.SHORT_NAME: datastore for datastore in DATASTORE_CLASSES}
...
def init_datastore(datastore_kind, config_path):
    ...
    if DatastoreClass is None:
        raise NotImplementedError(f"Datastore kind {datastore_kind} is not implemented")
